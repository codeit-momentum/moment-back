...
import { deleteNotification, getAndMarkNotificationsAsRead, sendNewNotificationsCount } from '../controllers/notificationController.js';
...
router.get('/notifications/unreadCount', sendNewNotificationsCount);    // 새로운 알림 개수 전송
